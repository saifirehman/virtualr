...
import video2 from "../assets/video2.mp4"; // video2 is imported but not used
  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <div className="flex justify-center my-10">
        ...
        <a
          href="#"
          className="py-3 px-4 mx-3 rounded-md border border-neutral-300 text-neutral-500"
        >
          Documentation
        </a>
      </div>
      <div className="flex mt-10 justify-center">
        <video
          ...
          loop
          muted
          className="rounded-lg w-1/2 border border-orange-700 shadow-lg shadow-orange-400 mx-2 my-4"
        >
